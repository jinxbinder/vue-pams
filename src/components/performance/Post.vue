  ...
  <div>
    ...
    <el-card>
      ...
      <el-form :inline="true" class="elForm">
        <el-form-item>
          <el-input v-model="pagination.queryString" placeholder="岗位/部门" class="filter-item" >
          </el-input>
        </el-form-item>
      ...
      <el-table :data="dataList" border stripe>
        ...
        <el-table-column label="岗位名称" prop="name" width="148px" align="center" ></el-table-column>
        <el-table-column label="岗位级别" prop="level" width="200px" align="center" ></el-table-column>
  ...
  export default {
    ...
    methods:{
      findPage(){
        ...
        this.$http.post(`/post/findByPostPage`,parm).then(res=>{
      ...
      edit(id){
        ...
        this.$http.get(`/post/findById?id=${id}`).then(res=>{
